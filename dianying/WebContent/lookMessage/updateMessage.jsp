...
th {
    ...
    <body bgcolor="CCCFFF">
        ...
        <div align="center">
            <table border="0" cellspacing="0" cellpadding="0" width="100%" align="center">
                <tr>
                    ...
                    <td width="33%">
                        <a href="http://localhost:8080/dianying/lookMessage/updatePassword.jsp">修改密码</a>
                    </td>
                </tr>
            </table>
        </div>
        <hr noshade>
        <br><br>
        <form action="http://localhost:8080/dianying/UpdateMessageServlet" method="post">
